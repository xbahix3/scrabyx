...
def check(email, password):
   ...
   # Start 
   block = request.get_response('POST', 'https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=AIzaSyCNXXqtUeO3-VtoNgChiNFkFE2kqy5SRsI', json=data, headers=headers, proxies=None, timeout=10)
